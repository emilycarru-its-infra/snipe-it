...
return [
    ...
    'carry_forward_title'  => 'Carry forward unused PO budget',
    'carry_forward_help'   => 'Posts last fiscal year\'s unused PO budget (each PO\'s budget minus what was committed against it) into :target as a carry-forward allocation. PO budget that was issued but not spent rolls into the new year.',
    'carry_forward_action' => 'Carry forward :source → :target',
    'carry_forward_none'   => 'Nothing to carry forward from :source — its committed spend met or exceeded its PO budgets.',
    ...
    'carry_forward_no_budget' => 'No purchase orders with budgets on file for :source, so there is nothing to carry forward.',
    'carry_forward_desc'   => 'Carried forward from :source — PO budgets :approved, committed against them :committed.',
