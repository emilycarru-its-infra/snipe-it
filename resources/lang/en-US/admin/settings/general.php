...
return [
    ...
    'default_eula_text' => 'Default acceptance text',
    'default_eula_text_placeholder' => 'Add your default acceptance text',
    'default_language' => 'Default Language',
    'default_eula_help_text' => 'You can also associate custom acceptance text with specific asset categories.',
    'acceptance_note' => 'Add a note for your decision (required if declining)',
    'display_asset_name' => 'Display Asset Name',
    'display_checkout_date' => 'Display Checkout Date',
    'display_eol' => 'Display End of Life in table view',
    'toolbar_title' => 'Toolbar',
    'toolbar_help' => 'Drag the tabs into the order you want; hide the ones this instance does not need. Permissions still apply — hiding a tab never grants access, and users only ever see tabs they can open.',
    'toolbar_hidden' => 'Hidden',
    'toolbar_saved' => 'Toolbar saved.',
    'display_qr' => 'Display 2D barcode',
    'display_alt_barcode' => 'Display 1D barcode',
    'barcode_type' => '2D Barcode Type',
    'alt_barcode_type' => '1D barcode type',
    'enabled' => 'Enabled',
    'eula_settings' => 'Acceptance &amp; Signatures',
    'eula_markdown' => 'This text allows <a href="https://help.github.com/articles/github-flavored-markdown/">Github flavored markdown</a>.',
    'agreements' => 'Agreements',
    'agreements_title' => 'Agreement Settings',
    'agreements_help' => 'User Agreement titles &amp; body copy + default acceptance text',
    ...
    'emails_intro' => 'Every email Snipe-IT can send, rendered with representative sample data so you can see exactly what recipients receive. Edit the subject and body of any email below — leave a field blank to keep the built-in default.',
    ...
    'emails_subject_help' => 'Leave blank to use the built-in default subject (shown as the placeholder).',
    'emails_body' => 'Body',
    ...
    'emails_test_send' => 'Send test to me',
    'emails_test_help' => 'Sends the saved version of this email (with sample data) to your own address.',
    ...
    'emails_no_preview' => 'This email is sent through the notification system; a preview isn’t available yet, but you can set who receives it above.',
    'emails_preview_missing' => 'Unknown email.',
    'emails_preview_error' => 'This email could not be previewed with the sample data.',
    'emails_delivery' => 'Delivery',
    'emails_delivery_help' => 'This notification goes to internal staff, so it can post to a Teams channel instead of an inbox. Notifications addressed to the person an item belongs to, or to a vendor, always stay on email.',
    ...
    'emails_teams_channel_help' => 'Which channel the card posts to. Channel webhook URLs are set as app settings from Key Vault, not here.',
    'emails_teams_channel_unconfigured' => 'no webhook configured',
    'emails_teams_split' => 'Too long for one card, so it posts as :count cards.',
    'emails_teams_not_routable' => 'This notification is addressed outside the university, so it is not routed to Teams.',
    'emails_view_email' => 'Email',
    'emails_view_card' => 'Teams card',
    'emails_badge_teams' => 'Teams',
    ...
    'general_settings_help' => 'General display, formats and more',
    'generate_backup' => 'Generate Backup',
    'google_workspaces' => 'Google Workspaces',
    'header_color' => 'Primary Theme Color',
    'header_color_help' => 'The accent color, used for themed buttons, badges, and the marker on the active navigation item. The sidebar and header themselves always use the page background, so this color does not paint them. Changes are previewed live but not saved until you click Save.',
    'link_dark_color' => 'Link Color for Dark Mode',
    'nav_link_color' => 'Accent Text Color',
    'nav_link_color_help' => 'Text color used on top of the accent color, on themed buttons and badges. It should have enough contrast against the accent color to be easily readable.',
