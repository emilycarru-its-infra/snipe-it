...
return [
    ...
    'compose_title' => 'Email students',
    'compose_help' => 'Opens from a stored template — edit freely, the send carries what this sheet shows. Merge fields resolve per student. Save writes the wording back to the selected template for next cycle.',
    'compose_recipients' => ':count approved with an address',
    'compose_no_recipients' => 'No approved projects with an email address in this show + year.',
    'compose_template' => 'Template',
    'compose_submit' => 'Send to :count student(s)',
    'compose_test_sent' => 'Test sent to :email.',
    'compose_save_no_template' => 'Pick a template to save this wording into.',
    'compose_field_student_name' => 'the student\'s name',
    'compose_field_show' => 'the exhibit name',
    'compose_field_year' => 'the show year',
    'compose_field_project_type' => 'the project type',
    'compose_field_requested_device' => 'the requested device',
    'compose_field_peripherals' => 'the requested peripherals',
    'compose_field_assigned_asset' => 'the assigned device',
