...
Reply to this email if the device above is not the one you are using, or if there is a period that will not work for you.',
    ...
    'flow_backlog_pointer_link' => 'Plan them in Forecast',
    'incoming_orders_title' => 'Incoming orders — :count line(s) not on a wave',
    'incoming_orders_hint' => 'Order lines no wave has claimed yet. They join the board automatically once a wave item links to them.',
