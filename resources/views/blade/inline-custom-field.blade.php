...
{{--
    ...
    [pencil] value [copy] layout as <x-inline-core-field>: the pencil (left)
    swaps the value for the right editor — a text input / textarea for free-text
    fields, a <select> for listbox/radio, checkboxes for checkbox — posting to
    hardware.field.update. Copy (right, muted, double-square) reuses the value's
    existing hidden copy target from <x-info-element.customfield>; that
