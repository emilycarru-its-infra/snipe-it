...
@section('title')
    {{ trans('admin/deployments/general.catalogs_admin_title') }}
    @parent
@stop

{{-- The two catalogs that shape deployment waves — wave types and
     per-device stages. They live under admin because they are set once
     and rarely touched; the waves page stays about the waves. --}}
@section('content')
