...
<div class="box box-default">
    <div class="box-header with-border">
        <h2 class="box-title">{{ trans('admin/custom_fields/general.field_assignments') }}</h2>
        <p class="text-muted" style="margin: 4px 0 0;">{{ trans('admin/custom_fields/general.field_assignments_about') }}</p>
    </div>
    <div class="box-body table-responsive no-padding">
        <table class="table table-hover table-striped">
            <thead>
