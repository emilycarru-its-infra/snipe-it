@php($agreementTypes = \App\Models\FacultyAgreement::AGREEMENT_TYPES)
@php($stages = \App\Models\FacultyAgreement::LIFECYCLE_STAGES)
@php($methods = \App\Models\FacultyAgreement::PAYMENT_METHODS)

<div class="form-group {{ $errors->has('agreement_type') ? 'has-error' : '' }}">
    <label for="agreement_type" class="col-md-3 control-label">{{ trans('admin/faculty-agreements/general.type') }}</label>
    <div class="col-md-7">
        <select id="agreement_type" name="agreement_type" class="form-control select2">
            @foreach ($agreementTypes as $type)
                <option value="{{ $type }}" {{ old('agreement_type', $agreement->agreement_type ?? '') === $type ? 'selected' : '' }}>
                    {{ trans('admin/purchase-orders/general.faculty_type_'.$type) }}
                </option>
            @endforeach
        </select>
    </div>
...
<div class="form-group">
    <label for="user_id" class="col-md-3 control-label">{{ trans('admin/faculty-agreements/general.faculty_member') }}</label>
    <div class="col-md-7">
...
<div class="form-group">
    <label for="asset_id" class="col-md-3 control-label">{{ trans('admin/faculty-agreements/general.asset') }}</label>
    <div class="col-md-7">
...
<div class="form-group {{ $errors->has('lifecycle_stage') ? 'has-error' : '' }}">
    <label for="lifecycle_stage" class="col-md-3 control-label">{{ trans('admin/faculty-agreements/general.lifecycle_stage') }}</label>
    <div class="col-md-7">
        <select id="lifecycle_stage" name="lifecycle_stage" class="form-control select2">
            @foreach ($stages as $stage)
                <option value="{{ $stage }}" {{ old('lifecycle_stage', $agreement->lifecycle_stage ?? 'eligible') === $stage ? 'selected' : '' }}>
                    {{ trans('admin/purchase-orders/general.faculty_stage_'.$stage) }}
                </option>
            @endforeach
        </select>
    </div>
...
<div class="form-group">
    <label for="base_program_price" class="col-md-3 control-label">{{ trans('admin/faculty-agreements/general.base_program_price') }}</label>
...
<div class="form-group">
    <label for="device_cost" class="col-md-3 control-label">{{ trans('admin/faculty-agreements/general.device_cost') }}</label>
...
<div class="form-group">
    <label for="top_up_amount" class="col-md-3 control-label">{{ trans('admin/faculty-agreements/general.top_up_amount') }}</label>
...
<div class="form-group">
    <label for="buyout_cost" class="col-md-3 control-label">{{ trans('admin/faculty-agreements/general.buyout_cost') }}</label>
...
<div class="form-group">
    <label for="payment_method" class="col-md-3 control-label">{{ trans('admin/faculty-agreements/general.payment_method') }}</label>
    <div class="col-md-7">
        <select id="payment_method" name="payment_method" class="form-control select2">
            ...
            @foreach ($methods as $method)
                <option value="{{ $method }}" {{ old('payment_method', $agreement->payment_method ?? '') === $method ? 'selected' : '' }}>
                    {{ trans('admin/purchase-orders/general.faculty_payment_'.$method) }}
                </option>
            @endforeach
        </select>
    </div>
...
<div class="form-group">
    <label for="installment_count" class="col-md-3 control-label">{{ trans('admin/faculty-agreements/general.installment_count') }}</label>
...
<div class="form-group">
    <label for="old_asset_tag" class="col-md-3 control-label">{{ trans('admin/faculty-agreements/general.old_asset_tag') }}</label>
...
<div class="form-group">
    <label for="lease_contract" class="col-md-3 control-label">{{ trans('admin/faculty-agreements/general.lease_contract') }}</label>
...
<div class="form-group">
    <label for="notes" class="col-md-3 control-label">{{ trans('admin/faculty-agreements/general.notes') }}</label>
    <div class="col-md-7">
