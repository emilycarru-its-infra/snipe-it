    ...
    <div class="list clearfix">
        ...
        <div class="col-md-4 col-lg-3 col-sm-6 col-xl-1">
          <div class="admin box box-default">
            <div class="box-body text-center">
              <h5>
                <a href="{{ route('settings.agreements.index') }}" class="settings_button">
                  <x-icon type="eula" class="fa-4x"/>
                  <br><br>
                  <span class="name">{{ trans('admin/settings/general.agreements') }}</span>
                  <span class="keywords" aria-hidden="true" style="display:none"> {{ trans('admin/settings/general.keywords.agreements') }}</span>
                </a>
              </h5>
              <p class="index-block">{!! trans('admin/settings/general.agreements_help') !!}</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 col-lg-3 col-sm-6 col-xl-1">
          <div class="admin box box-default">
            <div class="box-body text-center">
              <h5>
                <a href="{{ route('settings.emails.index') }}" class="settings_button">
                  <x-icon type="email" class="fa-4x"/>
                  <br><br>
                  <span class="name">{{ trans('admin/settings/general.emails') }}</span>
                  <span class="keywords" aria-hidden="true" style="display:none"> {{ trans('admin/settings/general.keywords.emails') }}</span>
                </a>
              </h5>
              <p class="index-block">{!! trans('admin/settings/general.emails_help') !!}</p>
            </div>
          </div>
        </div>
