{{-- Shared contract-report table. Renders the uniform
     {columns, rows[].cells, footer} shape every report builder returns.
     Used by the standalone report page (show.blade.php) and by the inline,
     lazy-loaded sections on /contracts (embed mode). --}}
