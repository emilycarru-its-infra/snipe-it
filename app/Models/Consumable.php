...
class Consumable extends SnipeModel
{
    ...
    public function users(): Relation
    {
        return $this->belongsToMany(User::class, 'consumables_users', 'consumable_id', 'assigned_to')
            ...
            // Asset checkouts always set the type explicitly. Matching null here
            // means a missed type degrades to the correct answer rather than
            // making the checkout disappear.
