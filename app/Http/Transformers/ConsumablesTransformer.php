...
class ConsumablesTransformer
{
    ...
    public function transformConsumable(Consumable $consumable)
    {
        $array = [
            ...
            'tracking_number' => ($consumable->tracking_number) ? e($consumable->tracking_number) : null,
            'tracking_carrier' => ($consumable->tracking_carrier) ? e($consumable->tracking_carrier) : null,
            'tracking_url' => Helper::trackingUrl($consumable->tracking_carrier, $consumable->tracking_number),
