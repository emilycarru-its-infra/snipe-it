 ...
 *
 * The prior year's unused PO budget is NOT posted here — the dashboard
 * computes it live (App\Services\BudgetCarry) so it tracks the committed
 * data as it's corrected. Posting a manual carry_forward row for a fiscal
 * year overrides the live figure.
 */
